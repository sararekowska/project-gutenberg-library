const Sidebar = () => {
  return (
    <section className="w-full bg-[#F1AE82] xl:h-screen xl:w-[26rem]">
      {/* logo and text  */}
      <div className="w-full flex items-center justify-evenly sm:justify-center">
        <img
      ...
      {/* search fields  */}
      <div className="w-full pb-5 mt-4 flex flex-col items-center">
        {/* search by name  */}
        <div className="flex flex-col mb-4">
          <span className="text-lg">search by name:</span>
          <input
            type="text"
            className="bg-[#D9D9D9] focus:outline-none pl-1 w-80"
          />
        </div>
      ...
      <div className="w-full flex justify-center pb-6">
        <span className="text-lg w-[320px] underline">
          my favourites {">>"}
        </span>
      </div>
    </section>
